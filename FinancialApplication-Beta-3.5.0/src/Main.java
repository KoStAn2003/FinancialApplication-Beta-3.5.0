...
public class Main {
    public static void main(String[] args) {
        ...
        MoneyConverter converter = new MoneyConverter(78.5, 88.7, 0.75);
        FinancialAdvisor dinnerAdvisor = new FinancialAdvisor();
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                double max = expensesManager.getExpensesSum();
                System.out.println("Всего потрачено: " + max);
            }  else if (command==8) {
               ...
               String maxCategoryName = expensesManager.getMaxCategoryName();
                System.out.println("В категории "+ maxCategoryName + " вы потратили больше всего.");
            } else if (command == 0) {
